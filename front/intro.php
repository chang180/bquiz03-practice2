  ...
  <div id="mm">
    <div class="tab rb" style="width:87%;">
      <div style="background:#FFF; width:100%; color:#333; text-align:left">
        ...
        <p style="margin:3px">影片分級 ： <img src="icon/<?=$row['level'];?>" style="display:inline-block;"><?=$level[$row['level']];?> </p>
        ...
        <table width="100%" border="0">
          <tbody>
            <tr>
              <td align="center"><input type="button" value="院線片清單" onclick="location.href='index.php?do=main'"></td>
            </tr>
          </tbody>
        </table>
      </div>
